...
Customer Profiling & Visualization:
Identified customers predicted to be retained and churned.
...
Online Security: A notable number of churned customers did not use 'Online Security' service.
